...
public class AdapterListaControleLeiteiro extends ArrayAdapter<ControleLeiteiro> {
    private Activity activity;
    private List<ControleLeiteiro> lProdutor;
    private static LayoutInflater inflater = null;

    public AdapterListaControleLeiteiro(Activity activity, int textViewResourceId, List<ControleLeiteiro> _lProdutores) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            holder.display_name.setText(lProdutor.get(position).getVaca());
