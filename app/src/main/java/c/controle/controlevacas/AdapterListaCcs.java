...
public class AdapterListaCcs extends ArrayAdapter<CCS> {
    private Activity activity;
    private List<CCS> lProdutor;
    private static LayoutInflater inflater = null;

    public AdapterListaCcs(Activity activity, int textViewResourceId, List<CCS> _lProdutores) {
